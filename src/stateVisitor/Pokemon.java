...
public class Pokemon implements PokemonState {
	...
	public void accept(Visitor v) {
		if (pokemonState == pokemonEvolveStageOne) {
			v.givePoints((PokemonEvolveStageOne) pokemonState);
		 } else if (pokemonState == pokemonEvolveStageTwo) {
			 v.givePoints((PokemonEvolveStageTwo) pokemonState);
		 } else {
			 v.givePoints((PokemonEvolveStageThree) pokemonState);
		 }
	}
